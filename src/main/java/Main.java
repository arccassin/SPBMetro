...
public class Main {
    private static Logger loggerFindedStation;
    private static Logger loggerErrorStation;
    ...
    public static void main(String[] args) {
        ...
        loggerFindedStation = LogManager.getLogger("FindedStationLogger");
        loggerErrorStation = LogManager.getLogger("ErrorStationLogger");
        loggerError = LogManager.getLogger("errorLogLogger");
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            loggerFindedStation.info("Station name : " + line);
            if (station != null) {
                return station;
            }
            System.out.println("Станция не найдена :(");
            loggerErrorStation.info("Станция не найдена : " + line);
        }
    }
